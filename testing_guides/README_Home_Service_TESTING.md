# Home Service Booking — Testing Guide

This guide provides a step-by-step walkthrough to test the Generic Booking Management System when configured for **Home Service Booking**.
...
2. **Configure the Industry Preset**
   - **Preset**: Select `Home Service Booking` from the dropdown list.
   - **Business Name**: Enter a name (e.g., "Test Home Service Booking Business").
...
2. **Create the Resource**
   ...
   - **Name**: `AC Repair & Servicing 01`
   - **Code**: `RES-01`
   - **Resource Type**: `AC Repair & Servicing`
...
1. **Set Operating Schedule**
   ...
   - **Resource**: `AC Repair & Servicing 01`
...
2. **Book the Service**
   - **Select Resource**: Choose `AC Repair & Servicing 01`.
