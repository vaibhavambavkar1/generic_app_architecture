# Interview Slot Booking — Testing Guide

This guide provides a step-by-step walkthrough to test the Generic Booking Management System when configured for **Interview Slot Booking**.
...
2. **Configure the Industry Preset**
   - **Preset**: Select `Interview Slot Booking` from the dropdown list.
   - **Business Name**: Enter a name (e.g., "Test Interview Slot Booking Business").
...
1. **Create a Resource Type (Panel)**
...
2. **Create the Resource**
   ...
   - **Name**: `Software Engineer Panel 01`
   - **Code**: `RES-01`
   - **Resource Type**: `Software Engineer Panel`
...
1. **Set Operating Schedule**
   ...
   - **Resource**: `Software Engineer Panel 01`
...
2. **Book the Service**
   - **Select Resource**: Choose `Software Engineer Panel 01`.
