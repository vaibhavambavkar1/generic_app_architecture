# Equipment Rental — Testing Guide

This guide provides a step-by-step walkthrough to test the Generic Booking Management System when configured for **Equipment Rental**.
...
2. **Configure the Industry Preset**
   - **Preset**: Select `Equipment Rental` from the dropdown list.
   - **Business Name**: Enter a name (e.g., "Test Equipment Rental Business").
...
1. **Create a Resource Type (Equipment)**
...
2. **Create the Resource**
   ...
   - **Name**: `Heavy Excavator 01`
   - **Code**: `RES-01`
   - **Resource Type**: `Heavy Excavator`
...
2. **Book the Service**
   - **Select Resource**: Choose `Heavy Excavator 01`.
