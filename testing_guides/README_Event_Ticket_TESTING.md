# Event Ticket Booking — Testing Guide

This guide provides a step-by-step walkthrough to test the Generic Booking Management System when configured for **Event Ticket Booking**.
...
2. **Configure the Industry Preset**
   - **Preset**: Select `Event Ticket Booking` from the dropdown list.
   - **Business Name**: Enter a name (e.g., "Test Event Ticket Booking Business").
...
1. **Create a Resource Type (Section)**
...
2. **Create the Resource**
   ...
   - **Name**: `VIP Front Row 01`
   - **Code**: `RES-01`
   - **Resource Type**: `VIP Front Row`
...
2. **Book the Service**
   - **Select Resource**: Choose `VIP Front Row 01`.
