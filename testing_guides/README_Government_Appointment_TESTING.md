# Government Appointment Booking — Testing Guide

This guide provides a step-by-step walkthrough to test the Generic Booking Management System when configured for **Government Appointment Booking**.
...
2. **Configure the Industry Preset**
   - **Preset**: Select `Government Appointment Booking` from the dropdown list.
   - **Business Name**: Enter a name (e.g., "Test Government Appointment Booking Business").
...
1. **Create a Resource Type (Service)**
...
2. **Create the Resource**
   ...
   - **Name**: `Passport Renewal 01`
   - **Code**: `RES-01`
   - **Resource Type**: `Passport Renewal`
...
2. **Book the Service**
   - **Select Resource**: Choose `Passport Renewal 01`.
