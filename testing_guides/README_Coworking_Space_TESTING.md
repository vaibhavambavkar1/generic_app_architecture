# Coworking Spaces — Testing Guide

This guide provides a step-by-step walkthrough to test the Generic Booking Management System when configured for **Coworking Spaces**.
...
2. **Configure the Industry Preset**
   - **Preset**: Select `Coworking Spaces` from the dropdown list.
   - **Business Name**: Enter a name (e.g., "Test Coworking Spaces Business").
...
1. **Create a Resource Type (Desk Type)**
...
2. **Book the Service**
   - **Select Resource**: Choose `Hot Desk 01`.
