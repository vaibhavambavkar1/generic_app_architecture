# Vehicle Rental — Testing Guide

This guide provides a step-by-step walkthrough to test the Generic Booking Management System when configured for **Vehicle Rental**.
...
2. **Configure the Industry Preset**
   - **Preset**: Select `Vehicle Rental` from the dropdown list.
   - **Business Name**: Enter a name (e.g., "Test Vehicle Rental Business").
...
1. **Create a Resource Type (Vehicle Class)**
...
2. **Create the Resource**
   ...
   - **Name**: `SUV - Toyota RAV4 01`
   - **Code**: `RES-01`
   - **Resource Type**: `SUV - Toyota RAV4`
...
2. **Book the Service**
   - **Select Resource**: Choose `SUV - Toyota RAV4 01`.
