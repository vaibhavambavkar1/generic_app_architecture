# Salon & Spa — Testing Guide

This guide provides a step-by-step walkthrough to test the Generic Booking Management System when configured for **Salon & Spa**.
...
2. **Configure the Industry Preset**
   - **Preset**: Select `Salon & Spa` from the dropdown list.
   - **Business Name**: Enter a name (e.g., "Test Salon & Spa Business").
...
2. **Create the Resource**
   ...
   - **Name**: `Haircut & Styling 01`
   - **Code**: `RES-01`
   - **Resource Type**: `Haircut & Styling`
...
2. **Book the Service**
   - **Select Resource**: Choose `Haircut & Styling 01`.
