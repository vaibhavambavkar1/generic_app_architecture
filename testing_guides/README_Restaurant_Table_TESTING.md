# Restaurant Table Reservation — Testing Guide

This guide provides a step-by-step walkthrough to test the Generic Booking Management System when configured for **Restaurant Table Reservation**.
...
2. **Configure the Industry Preset**
   - **Preset**: Select `Restaurant Table Reservation` from the dropdown list.
   - **Business Name**: Enter a name (e.g., "Test Restaurant Table Reservation Business").
...
1. **Create a Resource Type (Table Type)**
...
2. **Create the Resource**
   ...
   - **Name**: `Window Table for 2 01`
   - **Code**: `RES-01`
   - **Resource Type**: `Window Table for 2`
...
1. **Set Operating Schedule**
   ...
   - **Resource**: `Window Table for 2 01`
...
2. **Book the Service**
   - **Select Resource**: Choose `Window Table for 2 01`.
