# Marriage Hall Booking — Testing Guide

This guide provides a step-by-step walkthrough to test the Generic Booking Management System when configured for **Marriage Hall Booking**.
...
2. **Configure the Industry Preset**
   - **Preset**: Select `Marriage Hall Booking` from the dropdown list.
   - **Business Name**: Enter a name (e.g., "Test Marriage Hall Booking Business").
...
2. **Create the Resource**
   ...
   - **Name**: `Royal Wedding Hall 01`
   - **Code**: `RES-01`
   - **Resource Type**: `Royal Wedding Hall`
...
1. **Set Operating Schedule**
   ...
   - **Resource**: `Royal Wedding Hall 01`
...
2. **Book the Service**
   - **Select Resource**: Choose `Royal Wedding Hall 01`.
