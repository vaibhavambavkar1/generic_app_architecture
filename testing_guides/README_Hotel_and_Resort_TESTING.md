# Hotel & Resort Bookings — Testing Guide

This guide provides a step-by-step walkthrough to test the Generic Booking Management System when configured for **Hotel & Resort Bookings**.
...
2. **Configure the Industry Preset**
   - **Preset**: Select `Hotel & Resort Bookings` from the dropdown list.
   - **Business Name**: Enter a name (e.g., "Test Hotel & Resort Bookings Business").
...
1. **Create a Resource Type (Room Type)**
...
2. **Book the Service**
   - **Select Resource**: Choose `Deluxe Suite 01`.
