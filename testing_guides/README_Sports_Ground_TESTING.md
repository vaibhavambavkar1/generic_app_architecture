# Sports Ground Booking — Testing Guide

This guide provides a step-by-step walkthrough to test the Generic Booking Management System when configured for **Sports Ground Booking**.
...
2. **Configure the Industry Preset**
   - **Preset**: Select `Sports Ground Booking` from the dropdown list.
   - **Business Name**: Enter a name (e.g., "Test Sports Ground Booking Business").
...
1. **Create a Resource Type (Court)**
...
2. **Create the Resource**
   ...
   - **Name**: `Tennis Court 1 01`
   - **Code**: `RES-01`
   - **Resource Type**: `Tennis Court 1`
...
2. **Book the Service**
   - **Select Resource**: Choose `Tennis Court 1 01`.
