# Photography Booking — Testing Guide

This guide provides a step-by-step walkthrough to test the Generic Booking Management System when configured for **Photography Booking**.
...
2. **Configure the Industry Preset**
   - **Preset**: Select `Photography Booking` from the dropdown list.
   - **Business Name**: Enter a name (e.g., "Test Photography Booking Business").
...
2. **Create the Resource**
   ...
   - **Name**: `Wedding Shoot Full Day 01`
   - **Code**: `RES-01`
   - **Resource Type**: `Wedding Shoot Full Day`
...
1. **Set Operating Schedule**
   ...
   - **Resource**: `Wedding Shoot Full Day 01`
...
2. **Book the Service**
   - **Select Resource**: Choose `Wedding Shoot Full Day 01`.
