# Banquet Hall Booking — Testing Guide

This guide provides a step-by-step walkthrough to test the Generic Booking Management System when configured for **Banquet Hall Booking**.
...
2. **Configure the Industry Preset**
   - **Preset**: Select `Banquet Hall Booking` from the dropdown list.
   - **Business Name**: Enter a name (e.g., "Test Banquet Hall Booking Business").
...
2. **Create the Resource**
   ...
   - **Name**: `Grand Ballroom 01`
   - **Code**: `RES-01`
   - **Resource Type**: `Grand Ballroom`
...
2. **Book the Service**
   - **Select Resource**: Choose `Grand Ballroom 01`.
