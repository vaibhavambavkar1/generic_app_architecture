# Conference Room Booking — Testing Guide

This guide provides a step-by-step walkthrough to test the Generic Booking Management System when configured for **Conference Room Booking**.
...
2. **Configure the Industry Preset**
   - **Preset**: Select `Conference Room Booking` from the dropdown list.
   - **Business Name**: Enter a name (e.g., "Test Conference Room Booking Business").
...
2. **Book the Service**
   - **Select Resource**: Choose `Boardroom A 01`.
