# Taxi Booking — Testing Guide

This guide provides a step-by-step walkthrough to test the Generic Booking Management System when configured for **Taxi Booking**.
...
2. **Configure the Industry Preset**
   - **Preset**: Select `Taxi Booking` from the dropdown list.
   - **Business Name**: Enter a name (e.g., "Test Taxi Booking Business").
...
1. **Create a Resource Type (Vehicle)**
...
2. **Create the Resource**
   ...
   - **Name**: `Premium Sedan 01`
   - **Code**: `RES-01`
   - **Resource Type**: `Premium Sedan`
...
2. **Book the Service**
   - **Select Resource**: Choose `Premium Sedan 01`.
