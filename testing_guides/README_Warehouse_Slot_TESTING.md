# Warehouse Slot Booking — Testing Guide

This guide provides a step-by-step walkthrough to test the Generic Booking Management System when configured for **Warehouse Slot Booking**.
...
2. **Configure the Industry Preset**
   - **Preset**: Select `Warehouse Slot Booking` from the dropdown list.
   - **Business Name**: Enter a name (e.g., "Test Warehouse Slot Booking Business").
...
1. **Create a Resource Type (Storage Unit)**
...
2. **Create the Resource**
   ...
   - **Name**: `Climate Controlled 10x10 01`
   - **Code**: `RES-01`
   - **Resource Type**: `Climate Controlled 10x10`
...
1. **Set Operating Schedule**
   ...
   - **Resource**: `Climate Controlled 10x10 01`
...
2. **Book the Service**
   - **Select Resource**: Choose `Climate Controlled 10x10 01`.
