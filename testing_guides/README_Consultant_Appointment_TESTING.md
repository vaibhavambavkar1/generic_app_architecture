# Consultant Appointment Booking — Testing Guide

This guide provides a step-by-step walkthrough to test the Generic Booking Management System when configured for **Consultant Appointment Booking**.
...
2. **Configure the Industry Preset**
   - **Preset**: Select `Consultant Appointment Booking` from the dropdown list.
   - **Business Name**: Enter a name (e.g., "Test Consultant Appointment Booking Business").
...
1. **Create a Resource Type (Consultant)**
...
2. **Create the Resource**
   ...
   - **Name**: `Jane Doe - Legal 01`
   - **Code**: `RES-01`
   - **Resource Type**: `Jane Doe - Legal`
...
2. **Book the Service**
   - **Select Resource**: Choose `Jane Doe - Legal 01`.
