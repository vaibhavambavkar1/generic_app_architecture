# Parking Slot Booking — Testing Guide

This guide provides a step-by-step walkthrough to test the Generic Booking Management System when configured for **Parking Slot Booking**.
...
2. **Configure the Industry Preset**
   - **Preset**: Select `Parking Slot Booking` from the dropdown list.
   - **Business Name**: Enter a name (e.g., "Test Parking Slot Booking Business").
...
2. **Create the Resource**
   ...
   - **Name**: `Premium Covered Parking 01`
   - **Code**: `RES-01`
   - **Resource Type**: `Premium Covered Parking`
...
1. **Set Operating Schedule**
   ...
   - **Resource**: `Premium Covered Parking 01`
...
2. **Book the Service**
   - **Select Resource**: Choose `Premium Covered Parking 01`.
