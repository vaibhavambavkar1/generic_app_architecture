# Cinema Booking — Testing Guide

This guide provides a step-by-step walkthrough to test the Generic Booking Management System when configured for **Cinema Booking**.
...
2. **Configure the Industry Preset**
   - **Preset**: Select `Cinema Booking` from the dropdown list.
   - **Business Name**: Enter a name (e.g., "Test Cinema Booking Business").
...
1. **Create a Resource Type (Screen)**
...
2. **Create the Resource**
   ...
   - **Name**: `IMAX Screen 1 01`
   - **Code**: `RES-01`
   - **Resource Type**: `IMAX Screen 1`
...
2. **Book the Service**
   - **Select Resource**: Choose `IMAX Screen 1 01`.
