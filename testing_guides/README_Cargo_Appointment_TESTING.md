# Cargo Appointment Booking — Testing Guide

This guide provides a step-by-step walkthrough to test the Generic Booking Management System when configured for **Cargo Appointment Booking**.
...
2. **Configure the Industry Preset**
   - **Preset**: Select `Cargo Appointment Booking` from the dropdown list.
   - **Business Name**: Enter a name (e.g., "Test Cargo Appointment Booking Business").
...
2. **Create the Resource**
   ...
   - **Name**: `Loading Dock 4 01`
   - **Code**: `RES-01`
   - **Resource Type**: `Loading Dock 4`
...
2. **Book the Service**
   - **Select Resource**: Choose `Loading Dock 4 01`.
