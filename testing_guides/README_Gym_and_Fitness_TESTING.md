# Gym & Fitness Classes — Testing Guide

This guide provides a step-by-step walkthrough to test the Generic Booking Management System when configured for **Gym & Fitness Classes**.
...
2. **Configure the Industry Preset**
   - **Preset**: Select `Gym & Fitness Classes` from the dropdown list.
   - **Business Name**: Enter a name (e.g., "Test Gym & Fitness Classes Business").
...
1. **Create a Resource Type (Class)**
...
2. **Create the Resource**
   ...
   - **Name**: `Yoga Session 01`
   - **Code**: `RES-01`
   - **Resource Type**: `Yoga Session`
...
2. **Book the Service**
   - **Select Resource**: Choose `Yoga Session 01`.
