# Bus Booking — Testing Guide

This guide provides a step-by-step walkthrough to test the Generic Booking Management System when configured for **Bus Booking**.
...
2. **Configure the Industry Preset**
   - **Preset**: Select `Bus Booking` from the dropdown list.
   - **Business Name**: Enter a name (e.g., "Test Bus Booking Business").
...
1. **Create a Resource Type (Route)**
...
2. **Create the Resource**
   ...
   - **Name**: `NY to Boston - Express 01`
   - **Code**: `RES-01`
   - **Resource Type**: `NY to Boston - Express`
...
1. **Set Operating Schedule**
   ...
   - **Resource**: `NY to Boston - Express 01`
...
2. **Book the Service**
   - **Select Resource**: Choose `NY to Boston - Express 01`.
   - **Pick a Date**: Select the date you configured in the schedule.
   - **Select Slot**: Depending on the mode (`seat_selection`), pick your specific slot, duration, or seat selection.
